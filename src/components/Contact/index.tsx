    ...
    <>
      <div className="container contact-page">
        <div className="text-zone">
          ...
          <p>
            I am interested in freelance development and consultation
            opportunities. I prefer helping startups and small scale businesses.
        ...
        <div className="info-map">
          ...
          Punjab, Lahore <br />
          <br />
          <span>sallahuddinkh@gmail.com</span>
        </div>
